...
<br>
<font size=6pt color=#000077 face=verdana><b><i>Customers List</i></b></font></center><br>
<table width=98% >
...
<center>
 ...
 <tr><td  colspan=12 align=center  bgcolor=#b5d1ee height=20  style="font-size:9pt;font-family:verdana;color:#000066"><b>LIST OF CUSTOMERS</b></td></tr>
...
<%
             ...
             {
%> 
          <td  align="center"   height=20 bgcolor=#000077   style="font-weight:bold;font-size:7pt;font-family:verdana;color:white">
                       ...
                       for(int i=1;rs.next();i++)
                        {
                            ...
                            %>      
                                    ...
                                    %>  <td height=20  align=middle style="font-weight:bold;font-size:8pt;font-family:verdana;color:#000080"><%=rs.getString(j)%></td>
                                    <%
                                            }//eof for
                                      %>
                                   </tr>
